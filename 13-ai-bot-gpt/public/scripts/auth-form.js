document.addEventListener("DOMContentLoaded", () => {
    ...
    if (nameInput && nameContainer) {
        nameInput.addEventListener("input", function () {
            ...
            let wordLength = countWords(nameInput.value);
    ...
    if (emailInput && emailContainer && emailError) {
    ...
    // For Password
    if (passwordInput && passwordContainer && passwordError) {
    ...
    if (signupBtn && form && nameContainer && emailContainer && passwordContainer) {
